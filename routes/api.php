...
Route::get('menus/web', [MenuController::class, 'webMenu'])->name('menus.web');
...
Route::put('menu-paginas/{menuPagina}', [MenuPaginaController::class, 'update'])->name('menu-paginas.update');
Route::patch('menu-paginas/{menuPagina}', [MenuPaginaController::class, 'update']);
Route::delete('menu-paginas/{menuPagina}', [MenuPaginaController::class, 'destroy'])->name('menu-paginas.destroy');
